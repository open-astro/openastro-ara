...
- **Currently working on:** `phase-12h3-search` branch — §61 smart settings search (⌘K) cross-cutting all settings panels. Resolving Flutter 3.44.0 analyzer errors (initialValue -> value, withOpacity -> withValues, const-correctness, type inference).
