...
class FilterDef {
  ...
  /// narrowband filters — NOT the line center). This is the number the
  /// Optimal-Sub (Glover) math needs; without it, narrowband exposure
  /// suggestions fall back to a generic 7 nm.
  double? bandwidthNm;
...
class SafetyPolicies {
  ...
  // (playbook screen 15's client-offline auto-abort): whether the unattended
