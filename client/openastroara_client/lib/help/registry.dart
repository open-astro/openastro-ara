...
const Map<String, Help> helpRegistry = {
  ...
  'eq.auto_connect_on_boot': Help(
    ...
    body:
        ...
        '* Filter wheel — on the first connect of each Ara session (auto or manual) Ara itself parks the wheel on slot 0, conventionally L; a later reconnect leaves the wheel where it is. Drivers may also reposition on connect (driver-dependent).\n'
